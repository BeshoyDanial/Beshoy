...
#define NVIC_ISPR0			*((u32*)0xE000E200)  /* Set 1 on the Pending Flag*/
...
#define NVIC_IPR			((u8*)0xE000E400)   /* to be able to write on it with [] subscriptor operator, Couse it is u8* */
